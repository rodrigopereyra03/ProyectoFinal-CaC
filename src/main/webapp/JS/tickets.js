...
function total_a_pagar() {
    ...
    if (document.getElementById('categoriaSelect').value == "Sin categoria") {
        totalValorTickets = totalValorTickets ;
    }
    if (document.getElementById('categoriaSelect').value == "Estudiante") {
        totalValorTickets = totalValorTickets - (descuentoEstudiante / 100 * totalValorTickets);
    }
    if (document.getElementById('categoriaSelect').value == "Trainee") {
        totalValorTickets = totalValorTickets - (descuentoTrainee / 100 * totalValorTickets);
    }
    if (document.getElementById('categoriaSelect').value == "Junior") {
